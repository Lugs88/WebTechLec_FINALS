<!--
  This header is used when there is  no user logged in onto the website.
  There will be no username onto the nav bar.
-->
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a href="java-servlets.php" class="dropdown-item">Lesson 1: Servlets</a>
