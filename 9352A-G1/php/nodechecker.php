...
<html>
    ...
    <body>
        <?php
            ...
            $data = file_get_contents('../json/nodequiz.json');
            ...
            $sql = "UPDATE users SET quiz3 = $score WHERE username = '".$_SESSION['username']."'";
            ...
            $sql = "SELECT username, quiz3 FROM users ORDER BY quiz3 DESC LIMIT 10";
