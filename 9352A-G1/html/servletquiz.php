...
<html>
    <head>
        ...
        <title> Quiz - Java Servlets </title>
    ...
    <body>
        ...
        <p class="display-4 mt-0 mb-5 text-center">Java Servlets</p>
        <div class="quiz-form">
            <form method="post" action="../php/servletchecker.php" class="quiz">
                <ol id="quiz-list"></ol>
        ...
        <script src="../js/servletquiz.js"></script>
