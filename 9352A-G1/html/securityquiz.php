...
<html>
    ...
    <body>
        ...
        <div class="cover">
            <div class="bg-item-sm" style="background-image: url(../img/bg-security.png)"></div>
        </div>

        <h2 class="mt-5"> QUIZ </h2>
        <p class="display-4 mt-0 mb-5 text-center">Web Security</p>
        <div class="quiz-form">
            <form method="post" action="../php/securitychecker.php" class="quiz">
                <ol id="quiz-list"></ol>
        ...
        <script src="../js/securityquiz.js"></script>
